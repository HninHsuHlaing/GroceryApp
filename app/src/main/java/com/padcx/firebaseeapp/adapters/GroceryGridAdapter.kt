package com.padcx.firebaseeapp.adapters
 ...
 * on 10/18/2020
 */
class GroceryGridAdapter(private val mDelegate: GroceryViewItemActionDelegate) : BaseRecyclerAdapter<GroceryViewHolder, GroceryVO>() {
